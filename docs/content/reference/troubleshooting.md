...
Most of these come down to network reality or how urlscan serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

urlscan rate-limits like any public site. urlscan already paces
...
Where a surface is gated, urlscan reads a cookie or token you supply
...
`urlscan`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what urlscan actually did
