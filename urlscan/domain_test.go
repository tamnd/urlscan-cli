...
func TestHostWiring(t *testing.T) {
	...
	if want := "urlscan://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("urlscan", "about")
	if err != nil || got.String() != "urlscan://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want urlscan://page/about", got.String(), err)
	}
}
